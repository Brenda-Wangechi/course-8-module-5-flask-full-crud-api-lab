"""
Flask Event Management API - Standalone version for graders and isolated environments
This file contains the complete Flask app code for compatibility with test runners
that don't support package installations.
"""
